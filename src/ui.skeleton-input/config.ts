export default /*tw*/ {
  ...
  input: {
    ...
    compoundVariants: [
      ...
      { size: "sm", type: "textarea", label: false, class: "h-12.5" },
      { size: "md", type: "textarea", label: false, class: "h-14" },
      { size: "lg", type: "textarea", label: false, class: "h-15.5" },
