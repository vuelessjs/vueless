  ...
  () => {
    nextTick(() => {
      ...
      if (inputEl) {
        ...
        listboxInputBorderTop = parseFloat(
          listboxInputLabelStyle ? listboxInputLabelStyle.borderTop : "0",
        );
        listboxInputBorderBottom = parseFloat(
          listboxInputLabelStyle ? listboxInputLabelStyle.borderBottom : "0",
        );
      }
