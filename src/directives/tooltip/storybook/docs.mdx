...
## Theme Configuration
You can use Vueless’s default light/dark themes or create your own [custom one](https://atomiks.github.io/tippyjs/v6/themes/) via the global Vueless config:
...
## Customizing Styles
To customize the default light/dark or your own custom theme, simply update your CSS as shown below:
