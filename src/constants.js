...
export const APP_ICONS = `${ICONS_PATH}/app`;
export const STORYBOOK_ICONS = `${ICONS_PATH}/${STORYBOOK_DIR}`;
...
export const APP_ICONS_LOCAL_DIR = `src/${APP_ICONS}`;
export const APP_ICONS_CACHED_DIR = `${VUELESS_CACHE_DIR}/${APP_ICONS}`;
...
export const STORYBOOK_ICONS_LOCAL_PATH = `${VUELESS_LOCAL_DIR}/${STORYBOOK_ICONS}`;
export const STORYBOOK_ICONS_CACHED_PATH = `${VUELESS_CACHE_DIR}/${STORYBOOK_ICONS}`;
