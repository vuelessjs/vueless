...
export const TAILWIND_MERGE_EXTENSION = {
  extend: {
    ...
    classGroups: {
      ...
      "font-size": [{ text: ["2xs"] }],
      roundedSm: [{ rounded: ["dynamic-sm", "inherit"] }],
      "rounded-s-sm": [{ "rounded-s-sm": ["dynamic-sm", "inherit"] }],
      "rounded-e-sm": [{ "rounded-e-sm": ["dynamic-sm", "inherit"] }],
      "rounded-t-sm": [{ "rounded-t-sm": ["dynamic-sm", "inherit"] }],
      "rounded-r-sm": [{ "rounded-r-sm": ["dynamic-sm", "inherit"] }],
      "rounded-b-sm": [{ "rounded-b-sm": ["dynamic-sm", "inherit"] }],
      "rounded-l-sm": [{ "rounded-l-sm": ["dynamic-sm", "inherit"] }],
      "rounded-ss-sm": [{ "rounded-ss-sm": ["dynamic-sm", "inherit"] }],
      "rounded-se-sm": [{ "rounded-se-sm": ["dynamic-sm", "inherit"] }],
      "rounded-ee-sm": [{ "rounded-ee-sm": ["dynamic-sm", "inherit"] }],
      "rounded-es-sm": [{ "rounded-es-sm": ["dynamic-sm", "inherit"] }],
      "rounded-tl-sm": [{ "rounded-tl-sm": ["dynamic-sm", "inherit"] }],
      "rounded-tr-sm": [{ "rounded-tr-sm": ["dynamic-sm", "inherit"] }],
      "rounded-br-sm": [{ "rounded-br-sm": ["dynamic-sm", "inherit"] }],
      "rounded-bl-sm": [{ "rounded-bl-sm": ["dynamic-sm", "inherit"] }],
      ...
      roundedLg: [{ rounded: ["dynamic-lg", "inherit"] }],
      "rounded-s-lg": [{ "rounded-s-lg": ["dynamic-lg", "inherit"] }],
      "rounded-e-lg": [{ "rounded-e-lg": ["dynamic-lg", "inherit"] }],
      "rounded-t-lg": [{ "rounded-t-lg": ["dynamic-lg", "inherit"] }],
      "rounded-r-lg": [{ "rounded-r-lg": ["dynamic-lg", "inherit"] }],
      "rounded-b-lg": [{ "rounded-b-lg": ["dynamic-lg", "inherit"] }],
      "rounded-l-lg": [{ "rounded-l-lg": ["dynamic-lg", "inherit"] }],
      "rounded-ss-lg": [{ "rounded-ss-lg": ["dynamic-lg", "inherit"] }],
      "rounded-se-lg": [{ "rounded-se-lg": ["dynamic-lg", "inherit"] }],
      "rounded-ee-lg": [{ "rounded-ee-lg": ["dynamic-lg", "inherit"] }],
      "rounded-es-lg": [{ "rounded-es-lg": ["dynamic-lg", "inherit"] }],
      "rounded-tl-lg": [{ "rounded-tl-lg": ["dynamic-lg", "inherit"] }],
      "rounded-tr-lg": [{ "rounded-tr-lg": ["dynamic-lg", "inherit"] }],
      "rounded-br-lg": [{ "rounded-br-lg": ["dynamic-lg", "inherit"] }],
      "rounded-bl-lg": [{ "rounded-bl-lg": ["dynamic-lg", "inherit"] }],
    },
  },
};
