    ...
    <Transition v-bind="config.menuTransition">
      ...
      >
        <UDatePickerRangePeriodMenu
          ...
          :get-data-test="(suffix?: string) => getDataTest(suffix ? `period-menu-${suffix}` : 'period-menu')"
        ...
        <UDatePickerRangeInputs
          ...
          :get-data-test="(suffix?: string) => getDataTest(suffix ? `range-inputs-${suffix}` : 'range-inputs')"
        />
