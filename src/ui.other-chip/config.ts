export default /*tw*/ {
  ...
  chipDot: {
    ...
    compoundVariants: [
      { text: true, size: "sm", class: "min-w-[6px] w-auto h-auto px-1" },
      { text: true, size: "md", class: "min-w-[8px] w-auto h-auto px-1.5" },
      { text: true, size: "lg", class: "min-w-[12px] w-auto h-auto px-1.5" },
